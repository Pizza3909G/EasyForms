...
class Input extends Element {
	...
	public function getType(): string {
		return "\x69\x6e\x70\x75\x74";
	}

	public function serializeElementData(): array {
		return ["\x70\x6c\x61\x63\x65\x68\x6f\x6c\x64\x65\x72"=> $this->placeholder, "\x64\x65\x66\x61\x75\x6c\x74" => $this->default];
	}

	public function validate(mixed $value): void {
		if (!is_string($value)) {
			throw new FormValidationException("\x45\x78\x70\x65\x63\x74\x65\x64\x20\x73\x74\x72\x69\x6e\x67\x2c\x20\x67\x6f\x74\x20" . gettype($value));
		}
	}
}